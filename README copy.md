# <TODO_EXPANDED> Terraform module
...
See [`examples`](https://github.com/drizzle-ai-systems/terraform-aws-<TODO>/tree/main/examples) directory for working examples to reference:

```hcl
module "<TODO_UNDER>" {
  source = "drizzle-ai-systems/<TODO>/aws"
...
Apache-2.0 Licensed. See [LICENSE](https://github.com/drizzle-ai-systems/terraform-aws-<TODO>/blob/main/LICENSE).
